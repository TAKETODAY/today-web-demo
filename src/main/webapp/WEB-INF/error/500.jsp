...
<body>
	<div class="bg" align="center">
		...
		<a class="text" href="${pageContext.request.contextPath}/index.jsp">
		<img id="home" src="${CDN}/static/images/404/home.png" width="23"/>返回首页</a>
		<a class="text" href="javascript:(location=location)">
		<img id="refresh" src="${CDN}/static/images/404/refresh.png" width="20"/>刷新页面</a>
